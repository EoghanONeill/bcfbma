...
get_best_split_mu_bcf <- function(resids, data, treetable, tree_mat, a, mu, nu, lambda, c, lowest_BIC, parent, cp_mat, alpha, beta, maxOWsize, first_round) {
    .Call(`_bcfbma_get_best_split_mu_bcf`, resids, data, treetable, tree_mat, a, mu, nu, lambda, c, lowest_BIC, parent, cp_mat, alpha, beta, maxOWsize, first_round)
}
...
get_best_split_tau_round1_bcf <- function(resids, x_moderate_a, tree_table_tau, tree_mat_tau, a_mu, a_tau, mu_mu, mu_tau, nu, lambda, c, lowest_BIC, parent, cp_mat, alpha_mu, beta_mu, alpha_tau, beta_tau, maxOWsize, first_round, prev_sum_trees_mu, prev_sum_trees_mat_mu, y_scaled, parent2, i, z) {
    .Call(`_bcfbma_get_best_split_tau_round1_bcf`, resids, x_moderate_a, tree_table_tau, tree_mat_tau, a_mu, a_tau, mu_mu, mu_tau, nu, lambda, c, lowest_BIC, parent, cp_mat, alpha_mu, beta_mu, alpha_tau, beta_tau, maxOWsize, first_round, prev_sum_trees_mu, prev_sum_trees_mat_mu, y_scaled, parent2, i, z)
}
