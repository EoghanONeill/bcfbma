...
pred_ints_from_arma_bcf_TE<-function(object,num_iter,l_quant,u_quant,newdata=NULL){
  ...
  if(is.null(newdata) && length(object)==31){
    ...
    ret<-pred_ints_lin_alg_outsamp_bcf(object$sumoftrees_mu,object$sumoftrees_tau,
                                                    ...
                                                    object$num_propscores, object$nrowtest,l_quant,u_quant)
    ...
    ret<-pred_ints_lin_alg_insamp_bcf(object$sumoftrees_mu,object$sumoftrees_tau,
                                                   object$obs_to_termNodesMatrix_mu,object$obs_to_termNodesMatrix_tau,
                                                   object$response,
                                                   object$bic,num_iter,object$nrowTrain,
                                                   object$a_mu,object$a_tau,object$sigma,0,0,
                                                   object$nu,object$lambda,
                                                   object$z,l_quant,u_quant)
