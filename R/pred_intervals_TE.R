...
pred_intervals_TE<-function(object,num_iter,burnin,l_quant,u_quant,newdata=NULL){
  ...
  if(is.null(newdata) && length(object)==26){
  ...
  }else if(is.null(newdata) && length(object)==23){
