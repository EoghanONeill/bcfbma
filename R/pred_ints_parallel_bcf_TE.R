...
pred_ints_parallel_bcf_TE<-function(object,num_iter,l_quant,u_quant,newdata=NULL,num_cores=1){
  ...
  if(is.null(newdata) && length(object)==31){
    ...
    ret<-pred_ints_lin_alg_fields_outsamp_bcf(object$sumoftrees_mu,object$sumoftrees_tau,
    ...
    ret<-pred_ints_lin_alg_fields_insamp_bcf(object$sumoftrees_mu,object$sumoftrees_tau,
                                      object$obs_to_termNodesMatrix_mu,object$obs_to_termNodesMatrix_tau,
                                      object$response,
                                      object$bic,num_iter,object$nrowTrain,
                                      object$a_mu,object$a_tau,object$sigma,0,0,
