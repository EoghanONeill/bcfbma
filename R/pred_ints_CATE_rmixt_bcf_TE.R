#' @title Prediction intervals for BCF-BMA CATE estimates
#' 
...
pred_ints_CATE_rmixt_bcf_TE<-function(object,num_iter,l_quant,u_quant,newdata=NULL,num_cores=1){
  ...
  if(is.null(newdata) && length(object)==31){
    ...
    inputs_for_draws<-mean_vars_lin_alg_outsamp_cate(object$sumoftrees_mu,object$sumoftrees_tau,
    ...
    inputs_for_draws<-mean_vars_lin_alg_insamp_par_cate(object$sumoftrees_mu,object$sumoftrees_tau,
                                                       object$obs_to_termNodesMatrix_mu,object$obs_to_termNodesMatrix_tau,
                                                       object$response,
                                                       object$bic,num_iter,object$nrowTrain,
                                                       object$a_mu,object$a_tau,object$sigma,0,0,
