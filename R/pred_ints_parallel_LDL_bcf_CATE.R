...
pred_ints_parallel_LDL_bcf_CATE<-function(object,num_iter,l_quant,u_quant,newdata=NULL,num_cores=1){
  ...
  if(is.null(newdata) && length(object)==31){
    ...
    print("Haven't written out of sample CATE code yet.")
    ...
    ret<-pred_ints_lin_alg_fields_LDL_insamp_cate(object$sumoftrees_mu,object$sumoftrees_tau,
                                                 object$obs_to_termNodesMatrix_mu,object$obs_to_termNodesMatrix_tau,
                                                 object$response,
                                                 object$bic,num_iter,object$nrowTrain,
                                                 object$a_mu,object$a_tau,object$sigma,0,0,
